...
¶ building the mechanical {{< ℑ stress tensor >}} in a fluid: momentum flows 
  through a surface element d↗A, back to front.

¶ mechanical stress tensor ˝T₍m₎˝. flow of mechanical momentum.
  >> so what actually is "mechanical" momentum? mechanical, as opposed to what? 
     <<
  {.question}
...
¶ {{< ℑ incompressible fluid >}}: you're assuming variations of pressure are so small that 
